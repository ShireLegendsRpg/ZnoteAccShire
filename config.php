<?php
	...
	$config['site_title'] = 'Shire Legends';
	...
	$config['server_path'] = '/var/www/Server/';
	...
	$config['sqlPassword'] = 'shirelegends';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'msql';
	...
	*/
	...
	$config['available_vocations'] = array(9,10,11,12);
	...
	$config['show_outfits'] = array(
		...
		'imageServer' => 'outfitAndItems/animoutfit.php'
	);
